...
public class FordFulkerson {
	...
	public Double ffStart(Graph<String,DefaultWeightedEdge> gr, String quelle, String senke){
		...
		while(!ende){ // (2.3) Falls alle markierten Knoten inspiziert wurden, gehe nach 4
			// (2) Wähle einen beliebigen markierten, aber noch nicht inspizierten Knoten
			Iterator<String> it = markiert.keySet().iterator();
			String beliebigGewaehlterKnoten = it.next();
			while(inspiziert.contains(beliebigGewaehlterKnoten)){
				beliebigGewaehlterKnoten = it.next(); //ende der While Schleife = noch nicht inspiziert
			}
